...
export default function ProvablyFairModal({ isOpen, onClose, gameId }: ProvablyFairModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/90 backdrop-blur-sm">
      <div className="w-full max-w-6xl mx-4 h-[90vh] rounded-3xl bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl border border-white/20 shadow-2xl overflow-hidden">
        {/* Header */}
                      ...
                      <div className="space-y-3">
                        ...
                        {[
                          ...
                          <div key={key} className="flex items-center justify-between p-3 rounded-lg bg-white/10">
                            ...
                            <div className={`flex items-center space-x-2 ${
                              verificationResult.details[key] ? 'text-green-400' : 'text-red-400'
                            }`}>
